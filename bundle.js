	...
	class AudioVisualizer {
	  constructor() {
	    ...
	    this.cameraPositions = [
	      [new Vector3(-40, 5, 0), new Vector3(0, 5, 0)],
	      [new Vector3(-40, 20, 30), new Vector3(0, 0, 0)],
	      [new Vector3(0, 40, -1), new Vector3(0, 0, 0)],
	    ];
	  ...
	  createAxes() {
	    ...
	    const yAxis = new Line(
	      new BufferGeometry().setFromPoints([
	        new Vector3(-xSize / 2, 0, -ySize / 2 - 1),
	        new Vector3(-xSize / 2, 0, ySize / 2 + 1),
	      ]),
	      new LineBasicMaterial({ color: 0xffffff }),
	    );
	    ...
	    const zAxis = new Line(
	      new BufferGeometry().setFromPoints([
	        new Vector3(-xSize / 2, -1, -ySize / 2),
	        new Vector3(-xSize / 2, 11, -ySize / 2),
	      ]),
	      new LineBasicMaterial({ color: 0xffffff }),
	    );
	    ...
	    const yLabel = this.createSprite(
	      "Freq. (Hz)",
	      new Vector3(-xSize / 2 - 2, 0, ySize / 2 + 2),
	    );
	    const zLabel = this.createSprite(
	      "Power (dB)",
	      new Vector3(-xSize / 2, 12, -ySize / 2),
	    );
	  ...
	  createMultipleFFTLines() {
	    ...
	    for (let i = 0; i <= xSegments; i++) {
	      ...
	      shapeGeometry.setAttribute(
	        "position",
	        new Float32BufferAttribute(shapeVertices, 3),
	      );
	      shapeGeometry.setIndex(shapeIndices);
	      const shapeMesh = new Mesh(shapeGeometry, fillMaterial.clone());
	  ...
	  updateCameraPosition(currentTime) {
	    ...
	    const newLookAtPosition = new Vector3().lerpVectors(
	      this.startLookAtPosition,
